...
def test_vllm_lock_is_exact() -> None:
    ...
    assert lock == {
        ...
        "patched_layer_sha256": (
            "a79ba498cabc41bc03ca4f2e51b92d54422aa39de1f53032e88e13a012bbcbcd"
        ),
        "repository": "https://github.com/vllm-project/vllm.git",
        "tag": "v0.10.2",
        "torch": "2.8.0",
        "upstream_layer_sha256": (
            "f6a741cf80028f10c261ccdc72ab54b5301f865cb3a1cc5209656459cb796198"
        ),
    }
