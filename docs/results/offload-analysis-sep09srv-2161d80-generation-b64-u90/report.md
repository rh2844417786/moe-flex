...
|---|---|
|record_index|0|
|elapsed_s|37.149002600926906|
|generated_tokens|131072|
|memory[0].free_gpu_bytes|4316004352|
...
|memory[0].rank|0|
|memory[0].torch_allocated_bytes|74839426560|
|memory[0].torch_peak_allocated_bytes|75124360192|
|memory[0].torch_peak_reserved_bytes|75398905856|
|memory[0].torch_reserved_bytes|75398905856|
|memory[0].total_gpu_bytes|85017493504|
|memory[1].free_gpu_bytes|4316004352|
...
|memory[1].rank|1|
|memory[1].torch_allocated_bytes|74839426560|
|memory[1].torch_peak_allocated_bytes|75124360192|
|memory[1].torch_peak_reserved_bytes|75398905856|
|memory[1].torch_reserved_bytes|75398905856|
|memory[1].total_gpu_bytes|85017493504|
|memory[2].free_gpu_bytes|4316004352|
...
|memory[2].rank|2|
|memory[2].torch_allocated_bytes|74839426560|
|memory[2].torch_peak_allocated_bytes|75124360192|
|memory[2].torch_peak_reserved_bytes|75398905856|
|memory[2].torch_reserved_bytes|75398905856|
|memory[2].total_gpu_bytes|85017493504|
|memory[3].free_gpu_bytes|4316004352|
...
|memory[3].rank|3|
|memory[3].torch_allocated_bytes|74839426560|
|memory[3].torch_peak_allocated_bytes|75124360192|
|memory[3].torch_peak_reserved_bytes|75398905856|
|memory[3].torch_reserved_bytes|75398905856|
|memory[3].total_gpu_bytes|85017493504|
|output_tokens_per_second|3528.277768532327|
|repetition|0|
|request_count|64|
...
|memory[3].torch_reserved_bytes|75398905856|
|memory[3].total_gpu_bytes|85017493504|
|output_tokens_per_second|3560.956531750227|
|repetition|1|
|request_count|64|
|timing_eligible|True|
|artifact_kind|analysis-repetition|
...
|memory[3].torch_reserved_bytes|75398905856|
|memory[3].total_gpu_bytes|85017493504|
|output_tokens_per_second|3516.8189021558246|
|repetition|2|
|request_count|64|
|timing_eligible|True|
|artifact_kind|analysis-repetition|
