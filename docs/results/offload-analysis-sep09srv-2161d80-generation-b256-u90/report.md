...
|---|---|
|record_index|0|
|elapsed_s|67.45888877892867|
|generated_tokens|524288|
...
|memory[0].rank|0|
|memory[0].torch_allocated_bytes|74562646016|
|memory[0].torch_peak_allocated_bytes|75042441728|
...
|memory[1].rank|1|
|memory[1].torch_allocated_bytes|74562646016|
|memory[1].torch_peak_allocated_bytes|75042441728|
...
|memory[2].rank|2|
|memory[2].torch_allocated_bytes|74562646016|
|memory[2].torch_peak_allocated_bytes|75042441728|
...
|memory[3].rank|3|
|memory[3].torch_allocated_bytes|74562646016|
|memory[3].torch_peak_allocated_bytes|75042441728|
...
|output_tokens_per_second|7771.9631836533545|
|repetition|0|
|request_count|256|
...
|memory[3].torch_reserved_bytes|75629592576|
|memory[3].total_gpu_bytes|85017493504|
|output_tokens_per_second|7760.612989173993|
|repetition|1|
|request_count|256|
|timing_eligible|True|
|artifact_kind|analysis-repetition|
...
|memory[3].torch_reserved_bytes|75629592576|
|memory[3].total_gpu_bytes|85017493504|
|output_tokens_per_second|7743.775969151234|
|repetition|2|
|request_count|256|
|timing_eligible|True|
|artifact_kind|analysis-repetition|
