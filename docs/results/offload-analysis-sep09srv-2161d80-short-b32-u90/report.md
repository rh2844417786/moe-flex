...
|---|---|
|record_index|0|
|elapsed_s|2.7109443941153586|
|generated_tokens|4096|
|memory[0].free_gpu_bytes|4506845184|
...
|memory[0].rank|0|
|memory[0].torch_allocated_bytes|74839423488|
|memory[0].torch_peak_allocated_bytes|75124357632|
|memory[0].torch_peak_reserved_bytes|75298242560|
|memory[0].torch_reserved_bytes|75298242560|
|memory[0].total_gpu_bytes|85017493504|
|memory[1].free_gpu_bytes|4506845184|
...
|memory[1].rank|1|
|memory[1].torch_allocated_bytes|74839423488|
|memory[1].torch_peak_allocated_bytes|75124357632|
|memory[1].torch_peak_reserved_bytes|75298242560|
|memory[1].torch_reserved_bytes|75298242560|
|memory[1].total_gpu_bytes|85017493504|
|memory[2].free_gpu_bytes|4506845184|
...
|memory[2].rank|2|
|memory[2].torch_allocated_bytes|74839423488|
|memory[2].torch_peak_allocated_bytes|75124357632|
|memory[2].torch_peak_reserved_bytes|75298242560|
|memory[2].torch_reserved_bytes|75298242560|
|memory[2].total_gpu_bytes|85017493504|
|memory[3].free_gpu_bytes|4506845184|
...
|memory[3].rank|3|
|memory[3].torch_allocated_bytes|74839423488|
|memory[3].torch_peak_allocated_bytes|75124357632|
|memory[3].torch_peak_reserved_bytes|75298242560|
|memory[3].torch_reserved_bytes|75298242560|
|memory[3].total_gpu_bytes|85017493504|
|output_tokens_per_second|1510.9125841500766|
|repetition|0|
|request_count|32|
...
|memory[3].torch_reserved_bytes|75298242560|
|memory[3].total_gpu_bytes|85017493504|
|output_tokens_per_second|1512.1305023077807|
|repetition|1|
|request_count|32|
|timing_eligible|True|
|artifact_kind|analysis-repetition|
...
|memory[3].torch_reserved_bytes|75298242560|
|memory[3].total_gpu_bytes|85017493504|
|output_tokens_per_second|1511.5503069845356|
|repetition|2|
|request_count|32|
|timing_eligible|True|
|artifact_kind|analysis-repetition|
