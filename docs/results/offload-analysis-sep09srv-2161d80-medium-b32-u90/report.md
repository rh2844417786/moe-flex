...
|---|---|
|record_index|0|
|elapsed_s|10.781738752033561|
|generated_tokens|16384|
|memory[0].free_gpu_bytes|4502650880|
...
|memory[0].rank|0|
|memory[0].torch_allocated_bytes|74839422976|
|memory[0].torch_peak_allocated_bytes|75124359168|
|memory[0].torch_peak_reserved_bytes|75302436864|
|memory[0].torch_reserved_bytes|75302436864|
|memory[0].total_gpu_bytes|85017493504|
|memory[1].free_gpu_bytes|4502650880|
...
|memory[1].rank|1|
|memory[1].torch_allocated_bytes|74839422976|
|memory[1].torch_peak_allocated_bytes|75124359168|
|memory[1].torch_peak_reserved_bytes|75302436864|
|memory[1].torch_reserved_bytes|75302436864|
|memory[1].total_gpu_bytes|85017493504|
|memory[2].free_gpu_bytes|4502650880|
...
|memory[2].rank|2|
|memory[2].torch_allocated_bytes|74839422976|
|memory[2].torch_peak_allocated_bytes|75124359168|
|memory[2].torch_peak_reserved_bytes|75302436864|
|memory[2].torch_reserved_bytes|75302436864|
|memory[2].total_gpu_bytes|85017493504|
|memory[3].free_gpu_bytes|4502650880|
...
|memory[3].rank|3|
|memory[3].torch_allocated_bytes|74839422976|
|memory[3].torch_peak_allocated_bytes|75124359168|
|memory[3].torch_peak_reserved_bytes|75302436864|
|memory[3].torch_reserved_bytes|75302436864|
|memory[3].total_gpu_bytes|85017493504|
|output_tokens_per_second|1519.6064732054267|
|repetition|0|
|request_count|32|
...
|memory[3].torch_reserved_bytes|75302436864|
|memory[3].total_gpu_bytes|85017493504|
|output_tokens_per_second|1521.0752650950024|
|repetition|1|
|request_count|32|
|timing_eligible|True|
|artifact_kind|analysis-repetition|
...
|memory[3].torch_reserved_bytes|75302436864|
|memory[3].total_gpu_bytes|85017493504|
|output_tokens_per_second|1515.1912743316645|
|repetition|2|
|request_count|32|
|timing_eligible|True|
|artifact_kind|analysis-repetition|
