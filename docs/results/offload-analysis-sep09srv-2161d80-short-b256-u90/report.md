...
|memory[0].rank|0|
|memory[0].torch_allocated_bytes|74562638848|
|memory[0].torch_peak_allocated_bytes|75042434560|
...
|memory[1].rank|1|
|memory[1].torch_allocated_bytes|74562638848|
|memory[1].torch_peak_allocated_bytes|75042434560|
...
|memory[2].rank|2|
|memory[2].torch_allocated_bytes|74562638848|
|memory[2].torch_peak_allocated_bytes|75042434560|
...
|memory[3].rank|3|
|memory[3].torch_allocated_bytes|74562638848|
|memory[3].torch_peak_allocated_bytes|75042434560|
...
|output_tokens_per_second|2942.6566508397796|
|repetition|0|
|request_count|256|
...
|memory[3].torch_reserved_bytes|75629592576|
|memory[3].total_gpu_bytes|85017493504|
|output_tokens_per_second|2952.5084746338543|
|repetition|1|
|request_count|256|
|timing_eligible|True|
|artifact_kind|analysis-repetition|
...
|memory[3].torch_reserved_bytes|75629592576|
|memory[3].total_gpu_bytes|85017493504|
|output_tokens_per_second|2942.5904616414196|
|repetition|2|
|request_count|256|
|timing_eligible|True|
|artifact_kind|analysis-repetition|
